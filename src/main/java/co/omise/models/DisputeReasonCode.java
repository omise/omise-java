...
public enum DisputeReasonCode {
    ...
    @JsonProperty("non_matching_account_number")NonMatchingAccountNumber,
    ...
    @JsonProperty("transaction_not_recognised")TransactionNotRecognised,
    @JsonProperty("unauthorized_charge")UnauthorizedCharge;
}